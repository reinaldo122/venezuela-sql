...
INSERT INTO `ciudades` (`id`, `estado_id`, `ciudad`) VALUES
(1, 1, 'Maroa'),
(2, 1, 'Puerto Ayacucho'),
...
INSERT INTO `paises` (`id`,`pais`) VALUES (1,'Venezuela');
...
ALTER TABLE `estados`
  ADD CONSTRAINT `fk_estados_1` FOREIGN KEY (`pais_id`) REFERENCES `paises` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `ciudades`
  ADD CONSTRAINT `ciudades_ibfk_1` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
